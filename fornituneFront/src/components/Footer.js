        ...
        <footer>
            <div className='f-background__div flex'>
                ...
                <nav className='f-content__nav f-item__footer'>
                    ...
                    <Link className='f-nav_header' to="/Market_Place">Market Place</Link>
                    <Link className='f-nav_header' to="/Contatos">Contato</Link>
                    <Link className='f-nav_header' to="/Sobre">Sobre</Link>
